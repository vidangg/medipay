...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2410boximpl(m2404markNowz9LOYto());
    }
    ...
    public long m2404markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2413constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2403elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2402differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2401adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2413constructorimpl(LongSaturatedMathKt.m2399saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
