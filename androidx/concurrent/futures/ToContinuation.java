...
final class ToContinuation<T> implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            cancellableContinuation.resumeWith(Result.m944constructorimpl(AbstractResolvableFuture.getUninterruptibly(this.futureToObserve)));
            ...
            cancellableContinuation2.resumeWith(Result.m944constructorimpl(ResultKt.createFailure(nonNullCause)));
        }
    }
}
