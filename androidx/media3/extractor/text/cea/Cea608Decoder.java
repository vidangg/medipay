...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_ES_FR_CHARACTER_SET = {193, MlKitException.CODE_SCANNER_CANCELLED, 211, 218, 220, 252, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, PsExtractor.AUDIO_STREAM, 194, 199, 200, MlKitException.CODE_SCANNER_CAMERA_PERMISSION_NOT_GRANTED, MlKitException.CODE_SCANNER_APP_NAME_UNAVAILABLE, 235, MlKitException.CODE_SCANNER_PIPELINE_INFERENCE_ERROR, MlKitException.CODE_SCANNER_GOOGLE_PLAY_SERVICES_VERSION_TOO_OLD, 239, 212, 217, 249, 219, 171, 187};
    private static final int[] SPECIAL_PT_DE_CHARACTER_SET = {195, 227, MlKitException.CODE_SCANNER_PIPELINE_INITIALIZATION_ERROR, MlKitException.CODE_SCANNER_TASK_IN_PROGRESS, 236, 210, 242, 213, 245, 123, 125, 92, 94, 95, 124, 126, 196, 228, 214, 246, 223, 165, 164, 9474, 197, 229, 216, 248, 9484, 9488, 9492, 9496};
    ...
    protected void decode(SubtitleInputBuffer subtitleInputBuffer) {
        ...
        while (true) {
            ...
            if ((readUnsignedByte & 2) == 0 && (readUnsignedByte & 1) == this.selectedField) {
                byte b = (byte) (readUnsignedByte2 & WorkQueueKt.MASK);
                byte b2 = (byte) (readUnsignedByte3 & WorkQueueKt.MASK);
                if (b != 0 || b2 != 0) {
