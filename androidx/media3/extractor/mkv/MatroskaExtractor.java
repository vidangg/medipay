        ...
        public void initializeOutput(ExtractorOutput extractorOutput, int i) throws ParserException {
            ...
            switch (c) {
                ...
                case '\t':
                    ...
                    str3 = str5;
                    int i9 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    ...
                    Format build2 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 2:
                    ...
                    if (parseMsAcmCodecPrivate(new ParsableByteArray(getCodecPrivate(this.codecId)))) {
                        ...
                        if (i7 == 0) {
                            ...
                            str3 = str5;
                            int i92 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                            builder = new Format.Builder();
                            if (!MimeTypes.isAudio(str3)) {
                            }
                            if (this.name != null) {
                            ...
                            Format build22 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                    ...
                    str3 = str5;
                    int i922 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 3:
                    ...
                    str3 = str5;
                    int i9222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 4:
                    ...
                    str3 = str5;
                    int i92222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 5:
                    ...
                    str3 = str5;
                    int i922222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 6:
                    ...
                    str3 = str5;
                    int i9222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 7:
                    ...
                    str3 = str5;
                    int i92222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case '\b':
                    ...
                    str3 = str5;
                    int i922222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case '\n':
                    ...
                    str3 = str5;
                    int i9222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 11:
                    ...
                    str3 = str5;
                    int i92222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case '\f':
                    ...
                    str3 = str5;
                    int i922222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case '\r':
                    ...
                    str3 = str5;
                    int i9222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 14:
                    ...
                    str3 = str5;
                    int i92222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 21:
                    ...
                    str3 = str5;
                    int i922222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 16:
                    ...
                    str3 = str5;
                    int i9222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 17:
                    ...
                    str3 = str5;
                    int i92222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 18:
                    ...
                    str3 = str5;
                    int i922222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 19:
                    ...
                    str3 = str5;
                    int i9222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 20:
                    ...
                    str3 = str5;
                    int i92222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 22:
                    if (this.audioBitDepth != 32) {
                        ...
                        str3 = str5;
                        int i922222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                        builder = new Format.Builder();
                        if (!MimeTypes.isAudio(str3)) {
                        }
                        if (this.name != null) {
                        }
                        Format build222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                    ...
                    str3 = str5;
                    int i9222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 23:
                    ...
                    if (i12 == 8) {
                        ...
                        i7 = C.ENCODING_PCM_24BIT_BIG_ENDIAN;
                    } else {
                        if (i12 != 32) {
                            ...
                            str3 = str5;
                            int i92222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                            builder = new Format.Builder();
                            if (!MimeTypes.isAudio(str3)) {
                            }
                            if (this.name != null) {
                            }
                            Format build22222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                        ...
                        i7 = C.ENCODING_PCM_32BIT_BIG_ENDIAN;
                    }
                    singletonList = null;
                    str = null;
                    i2 = 0;
                    ...
                    str3 = str5;
                    int i922222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 24:
                    ...
                    if (i7 == 0) {
                        ...
                        str3 = str5;
                        int i9222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                        builder = new Format.Builder();
                        if (!MimeTypes.isAudio(str3)) {
                        }
                        if (this.name != null) {
                        }
                        Format build2222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                    ...
                    str3 = str5;
                    int i92222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 25:
                    ...
                    str3 = str5;
                    int i922222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 26:
                    ...
                    str3 = str5;
                    int i9222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 27:
                    ...
                    str3 = str5;
                    int i92222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 28:
                    ...
                    str3 = str5;
                    int i922222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922222222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 29:
                    ...
                    str3 = str5;
                    int i9222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222222222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 30:
                    ...
                    str3 = str5;
                    int i92222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222222222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case 31:
                    ...
                    str3 = str5;
                    int i922222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build222222222222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i922222222222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                ...
                case ' ':
                    ...
                    str3 = str5;
                    int i9222222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | (!this.flagForced ? 2 : i2);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build2222222222222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i9222222222222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
