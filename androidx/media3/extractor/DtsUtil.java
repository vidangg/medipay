    ...
    */
    ...
    public static DtsHeader parseDtsHdHeader(byte[] bArr) throws ParserException {
        ...
        if (readBit) {
            ...
            j = Util.scaleLargeTimestamp(i7, 1000000L, i6);
        } else {
            j = C.TIME_UNSET;
        }
    ...
    public static DtsHeader parseDtsUhdHeader(byte[] bArr, AtomicInteger atomicInteger) throws ParserException {
        ...
        for (int i8 = 0; i8 < 1; i8++) {
            ...
            i6 += atomicInteger.get() != 0 ? parseUnsignedVarInt(normalizedFrame, UHD_AUDIO_CHUNK_SIZE_LENGTH_TABLE, true) : 0;
        }
        return new DtsHeader(MimeTypes.AUDIO_DTS_X, 2, i5, parseUnsignedVarInt + i6, j2, 0);
    }
