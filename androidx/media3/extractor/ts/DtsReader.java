...
public final class DtsReader implements ElementaryStreamReader {
    ...
    private void parseExtensionSubstreamHeader() throws ParserException {
        ...
        this.sampleDurationUs = parseDtsHdHeader.frameDurationUs == C.TIME_UNSET ? 0L : parseDtsHdHeader.frameDurationUs;
    }
    ...
    private void parseUhdHeader() throws ParserException {
        ...
        this.sampleDurationUs = parseDtsUhdHeader.frameDurationUs == C.TIME_UNSET ? 0L : parseDtsUhdHeader.frameDurationUs;
    }
    ...
    private void updateFormatWithDtsHeaderInfo(DtsUtil.DtsHeader dtsHeader) {
        ...
        Format build = (format == null ? new Format.Builder() : format.buildUpon()).setId(this.formatId).setSampleMimeType(dtsHeader.mimeType).setChannelCount(dtsHeader.channelCount).setSampleRate(dtsHeader.sampleRate).setLanguage(this.language).setRoleFlags(this.roleFlags).build();
        this.format = build;
