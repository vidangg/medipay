...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (MimeTypes.AUDIO_DTS_EXPRESS.equals(format.sampleMimeType) && i15 == -1) {
            i15 = 768000;
        }
        int i16 = i15;
        if (i != 0) {
            ...
            i9 = i3;
            i10 = i4;
            bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i4, intValue, i5), i5, i6, i3 != -1 ? i3 : 1, i4, i16, z2 ? 8.0d : 1.0d);
        }
    ...
    private void writeBuffer(ByteBuffer byteBuffer, long j) throws AudioSink.WriteException {
        ...
        if (writeNonBlockingV21 < 0) {
            if (isAudioTrackDeadObject(writeNonBlockingV21)) {
                ...
                writeException = new AudioSink.WriteException(writeNonBlockingV21, this.configuration.inputFormat, r2);
