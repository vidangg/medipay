...
public final class OutputConsumerAdapterV30 implements MediaParser$OutputConsumer {
    ...
    private static androidx.media3.common.DrmInitData toExoPlayerDrmInitData(String str, DrmInitData drmInitData) {
    ...
    private static final class SeekMapAdapter implements SeekMap {
        ...
        public SeekMap.SeekPoints getSeekPoints(long j) {
            ...
            if (seekPoints.first == seekPoints.second) {
                return new SeekMap.SeekPoints(asExoPlayerSeekPoint(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m463m(seekPoints.first)));
            }
            return new SeekMap.SeekPoints(asExoPlayerSeekPoint(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m463m(seekPoints.first)), asExoPlayerSeekPoint(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m463m(seekPoints.second)));
        }
    ...
    private static final class DataReaderAdapter implements DataReader {
        ...
        public int read(byte[] bArr, int i, int i2) throws IOException {
            int read;
            read = FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m462m(Util.castNonNull(this.input)).read(bArr, i, i2);
            return read;
        }
    }
}
