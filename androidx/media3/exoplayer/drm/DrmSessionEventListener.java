...
public interface DrmSessionEventListener {
    ...
    public static class EventDispatcher {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda3
                    ...
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m453x3233dce6(drmSessionEventListener, i);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m453x3233dce6(DrmSessionEventListener drmSessionEventListener, int i) {
        ...
        public void drmKeysLoaded() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m450x8fe293c0(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m450x8fe293c0(DrmSessionEventListener drmSessionEventListener) {
        ...
        public void drmSessionManagerError(final Exception exc) {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m454x18253075(drmSessionEventListener, exc);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m454x18253075(DrmSessionEventListener drmSessionEventListener, Exception exc) {
        ...
        public void drmKeysRestored() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m452xcfc47b53(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m452xcfc47b53(DrmSessionEventListener drmSessionEventListener) {
        ...
        public void drmKeysRemoved() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m451x5d8fdb2(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m451x5d8fdb2(DrmSessionEventListener drmSessionEventListener) {
        ...
        public void drmSessionReleased() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m455x690251a(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m455x690251a(DrmSessionEventListener drmSessionEventListener) {
