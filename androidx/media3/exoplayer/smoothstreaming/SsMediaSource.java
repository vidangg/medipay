...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    private void processManifest() {
        ...
        if (j2 == Long.MAX_VALUE) {
            ...
            singlePeriodTimeline = new SinglePeriodTimeline(C.TIME_UNSET, j4, j3, msToUs, true, true, true, (Object) this.manifest, getMediaItem());
        } else {
            long j5 = this.manifest.durationUs != C.TIME_UNSET ? this.manifest.durationUs : j - j2;
            singlePeriodTimeline = new SinglePeriodTimeline(j2 + j5, j5, j2, 0L, true, false, false, (Object) this.manifest, getMediaItem());
        }
