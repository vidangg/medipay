...
public final class MediaMetricsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public static MediaMetricsListener create(Context context) {
        ...
        MediaMetricsManager m464m = FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m464m(context.getSystemService("media_metrics"));
        if (m464m == null) {
            return null;
        }
        createPlaybackSession = m464m.createPlaybackSession();
    ...
    public void onSessionActive(AnalyticsListener.EventTime eventTime, String str) {
        ...
        if (eventTime.mediaPeriodId == null || !eventTime.mediaPeriodId.isAd()) {
            ...
            playerName = Util$$ExternalSyntheticApiModelOutline0.m387m().setPlayerName(MediaLibraryInfo.TAG);
    ...
    private void maybeUpdateMetricsBuilderValues(Player player, AnalyticsListener.Events events) {
        ...
        if (events.contains(2) && this.metricsBuilder != null && (drmInitData = getDrmInitData(player.getCurrentTracks().getGroups())) != null) {
            Util$$ExternalSyntheticApiModelOutline0.m(Util.castNonNull(this.metricsBuilder)).setDrmType(getDrmType(drmInitData));
        }
    ...
    private void maybeReportPlaybackError(long j) {
        ...
        timeSinceCreatedMillis = Util$$ExternalSyntheticApiModelOutline0.m386m().setTimeSinceCreatedMillis(j - this.startTimeMs);
    ...
    private void maybeReportNetworkChange(long j) {
        ...
        if (networkType2 != this.currentNetworkType) {
            ...
            PlaybackSession playbackSession = this.playbackSession;
            networkType = Util$$ExternalSyntheticApiModelOutline0.m385m().setNetworkType(networkType2);
    ...
    private void maybeReportPlaybackStateChange(Player player, AnalyticsListener.Events events, long j) {
        ...
        if (this.currentPlaybackState != resolveNewPlaybackState) {
            ...
            this.reportedEventsForCurrentSession = true;
            PlaybackSession playbackSession = this.playbackSession;
            state = FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m465m().setState(this.currentPlaybackState);
    ...
    private void reportTrackChangeEvent(int i, long j, Format format, int i2) {
        ...
        timeSinceCreatedMillis = FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m(i).setTimeSinceCreatedMillis(j - this.startTimeMs);
        if (format != null) {
