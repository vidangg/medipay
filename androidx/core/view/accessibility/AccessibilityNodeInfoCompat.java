...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ACTION_PAGE_UP = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 29 ? Util$$ExternalSyntheticApiModelOutline0.m394m() : null, R.id.accessibilityActionPageUp, null, null, null);
            ACTION_PAGE_DOWN = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 29 ? Util$$ExternalSyntheticApiModelOutline0.m401m$1() : null, R.id.accessibilityActionPageDown, null, null, null);
            ACTION_PAGE_LEFT = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 29 ? Util$$ExternalSyntheticApiModelOutline0.m402m$2() : null, R.id.accessibilityActionPageLeft, null, null, null);
            ACTION_PAGE_RIGHT = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 29 ? Util$$ExternalSyntheticApiModelOutline0.m403m$3() : null, R.id.accessibilityActionPageRight, null, null, null);
            ...
            ACTION_PRESS_AND_HOLD = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 30 ? Util$$ExternalSyntheticApiModelOutline0.m404m$4() : null, R.id.accessibilityActionPressAndHold, null, null, null);
            ACTION_IME_ENTER = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 30 ? Util$$ExternalSyntheticApiModelOutline0.m405m$5() : null, R.id.accessibilityActionImeEnter, null, null, null);
            ACTION_DRAG_START = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 32 ? Util$$ExternalSyntheticApiModelOutline0.m406m$6() : null, R.id.ALT, null, null, null);
            ACTION_DRAG_DROP = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 32 ? Util$$ExternalSyntheticApiModelOutline0.m407m$7() : null, R.id.CTRL, null, null, null);
            ACTION_DRAG_CANCEL = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 32 ? Util$$ExternalSyntheticApiModelOutline0.m$8() : null, R.id.FUNCTION, null, null, null);
            ACTION_SHOW_TEXT_SUGGESTIONS = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 33 ? Util$$ExternalSyntheticApiModelOutline0.m$9() : null, R.id.KEYCODE_0, null, null, null);
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public int getRegionCount() {
            if (Build.VERSION.SDK_INT >= 29) {
                return Util$$ExternalSyntheticApiModelOutline0.m(this.mInfo);
            }
            return 0;
        }
        ...
        public Region getRegionAt(int i) {
            if (Build.VERSION.SDK_INT >= 29) {
                return Util$$ExternalSyntheticApiModelOutline0.m(this.mInfo, i);
            }
            return null;
        }
        ...
        public AccessibilityNodeInfoCompat getTargetForRegion(Region region) {
            ...
            if (Build.VERSION.SDK_INT < 29 || (m = Util$$ExternalSyntheticApiModelOutline0.m(this.mInfo, region)) == null) {
                return null;
            }
    ...
    public boolean isTextEntryKey() {
        if (Build.VERSION.SDK_INT >= 29) {
            return Util$$ExternalSyntheticApiModelOutline0.m399m(this.mInfo);
        }
    ...
    public void setTextEntryKey(boolean z) {
        if (Build.VERSION.SDK_INT >= 29) {
            Util$$ExternalSyntheticApiModelOutline0.m(this.mInfo, z);
        } else {
    ...
    public TouchDelegateInfoCompat getTouchDelegateInfo() {
        ...
        if (Build.VERSION.SDK_INT < 29 || (m = Util$$ExternalSyntheticApiModelOutline0.m(this.mInfo)) == null) {
            return null;
        }
    ...
    public void setTouchDelegateInfo(TouchDelegateInfoCompat touchDelegateInfoCompat) {
        if (Build.VERSION.SDK_INT >= 29) {
            Util$$ExternalSyntheticApiModelOutline0.m(this.mInfo, touchDelegateInfoCompat.mInfo);
        }
    }
