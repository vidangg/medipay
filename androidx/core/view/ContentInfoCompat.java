...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return ComponentDialog$$ExternalSyntheticApiModelOutline0.m18m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    public static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = ComponentDialog$$ExternalSyntheticApiModelOutline0.m18m(Preconditions.checkNotNull(contentInfo));
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ClipData clipData, int i) {
            this.mPlatformBuilder = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(clipData, i);
        }

        BuilderCompat31Impl(ContentInfoCompat contentInfoCompat) {
            ComponentDialog$$ExternalSyntheticApiModelOutline0.m25m();
            this.mPlatformBuilder = ComponentDialog$$ExternalSyntheticApiModelOutline0.m17m(contentInfoCompat.toContentInfo());
        }
