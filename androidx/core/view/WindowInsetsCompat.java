...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = ComponentDialog$$ExternalSyntheticApiModelOutline0.m19m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m19m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m19m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(windowInsets);
            } else {
                m19m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m19m();
            }
            this.mPlatBuilder = m19m;
        }
