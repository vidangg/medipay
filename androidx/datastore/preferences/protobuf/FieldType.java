...
public enum FieldType {
    ...
    FieldType(int id, Collection collection, JavaType javaType) {
        ...
        int i2 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i2 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i == 2 || i == 3) ? false : true;
    }
