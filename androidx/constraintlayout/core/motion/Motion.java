...
public class Motion implements TypedValues {
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        double[][] dArr = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i4, this.mInterpolateVariables.length);
        ...
        while (true) {
            ...
            for (int i18 = 0; i18 < i4; i18++) {
                if (motionPathsArr[i18].hasCustomData(str8)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i4];
                        dArr4 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i4, motionPathsArr[i18].getCustomDataCount(str8));
                    }
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            double[][] dArr6 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i4, 2);
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f6 = this.mStartMotionPath.x + ((this.mEndMotionPath.x - this.mStartMotionPath.x) * f5) + 0.5f;
            float f7 = this.mStartMotionPath.y + ((this.mEndMotionPath.y - this.mStartMotionPath.y) * f5) + 0.5f;
            motionWidget.layout((int) f6, (int) f7, (int) (f6 + this.mStartMotionPath.width + ((this.mEndMotionPath.width - this.mStartMotionPath.width) * f5)), (int) (f7 + this.mStartMotionPath.height + ((this.mEndMotionPath.height - this.mStartMotionPath.height) * f5)));
        }
