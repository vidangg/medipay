    ...
    */
    void processTouchRotateEvent(MotionEvent event, MotionLayout.MotionTracker velocityTracker, int currentState, MotionScene motionScene) {
        ...
        if (action != 1) {
            ...
            if (i3 != -1) {
                View findViewById = this.mMotionLayout.findViewById(i3);
        ...
        if (i6 != -1) {
            View findViewById2 = this.mMotionLayout.findViewById(i6);
            this.mMotionLayout.getLocationOnScreen(this.mTempLoc);
            ...
            if (i7 != -1) {
                View findViewById3 = this.mMotionLayout.findViewById(this.mMotionLayout.getMotionController(i7).getAnimateRelativeTo());
                this.mMotionLayout.getLocationOnScreen(this.mTempLoc);
