    ...
    public static final class Companion {
        ...
        public final List<android.adservices.measurement.WebSourceParams> convertWebSourceParams$ads_adservices_release(List<WebSourceParams> request) {
            ...
            for (WebSourceParams webSourceParams : request) {
                CanvasUtils$$ExternalSyntheticApiModelOutline0.m600m$1();
                debugKeyAllowed = CanvasUtils$$ExternalSyntheticApiModelOutline0.m585m(webSourceParams.getRegistrationUri()).setDebugKeyAllowed(webSourceParams.getDebugKeyAllowed());
