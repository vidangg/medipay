...
public final class WebSourceRegistrationRequest {
    ...
    public final android.adservices.measurement.WebSourceRegistrationRequest convertToAdServices$ads_adservices_release() {
        ...
        CanvasUtils$$ExternalSyntheticApiModelOutline0.m$2();
        webDestination = CanvasUtils$$ExternalSyntheticApiModelOutline0.m((List) WebSourceParams.INSTANCE.convertWebSourceParams$ads_adservices_release(this.webSourceParams), this.topOriginUri).setWebDestination(this.webDestination);
