...
public class Camera2CameraControlImpl implements CameraControlInternal {
    ...
    public Camera2CameraControlImpl(CameraCharacteristicsCompat cameraCharacteristicsCompat, ScheduledExecutorService scheduledExecutorService, Executor executor, CameraControlInternal.ControlUpdateCallback controlUpdateCallback, Quirks quirks) {
        ...
        executor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda1
            ...
            public final void run() {
                Camera2CameraControlImpl.this.m46xc707fb02();
            }
        });
    }
    ...
    public /* synthetic */ void m46xc707fb02() {
    ...
    private ListenableFuture<Void> waitForSessionUpdateId(final long j) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda5
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CameraControlImpl.this.m51x20143706(j, completer);
            }
        });
    }
    ...
    public /* synthetic */ Object m51x20143706(final long j, final CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public ListenableFuture<List<Void>> submitStillCaptureRequests(final List<CaptureConfig> list, final int i, final int i2) {
        ...
        return FutureChain.from(Futures.nonCancellationPropagating(this.mFlashModeChangeSessionUpdateFuture)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda2
            ...
            public final ListenableFuture apply(Object obj) {
                return Camera2CameraControlImpl.this.m48xd133171b(list, i, flashMode, i2, (Void) obj);
            }
        }, this.mExecutor);
    }
    ...
    public /* synthetic */ ListenableFuture m48xd133171b(List list, int i, int i2, int i3, Void r5) throws Exception {
    ...
    ListenableFuture<Void> updateSessionConfigAsync() {
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda8
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CameraControlImpl.this.m50x6775df50(completer);
            }
        }));
    }
    ...
    public /* synthetic */ Object m50x6775df50(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraControlImpl.this.m49x56c0128f(completer);
            }
        });
    ...
    public /* synthetic */ void m49x56c0128f(CallbackToFutureAdapter.Completer completer) {
    ...
    public void addSessionCameraCaptureCallback(final Executor executor, final CameraCaptureCallback cameraCaptureCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraControlImpl.this.m45x48c3417b(executor, cameraCaptureCallback);
            }
        });
    }
    ...
    public /* synthetic */ void m45x48c3417b(Executor executor, CameraCaptureCallback cameraCaptureCallback) {
    ...
    public void removeSessionCameraCaptureCallback(final CameraCaptureCallback cameraCaptureCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraControlImpl.this.m47xd0890cf9(cameraCaptureCallback);
            }
        });
    }
    ...
    public /* synthetic */ void m47xd0890cf9(CameraCaptureCallback cameraCaptureCallback) {
    ...
    public static final class CameraControlSessionCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureCompleted(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, final TotalCaptureResult totalCaptureResult) {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$CameraControlSessionCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Camera2CameraControlImpl.CameraControlSessionCallback.this.m52xf57ef947(totalCaptureResult);
                }
            });
        }
        ...
        public /* synthetic */ void m52xf57ef947(TotalCaptureResult totalCaptureResult) {
