...
public class FragmentStateManager {
    ...
    int computeExpectedState() {
        ...
        if (this.mFragment.mTransitioning && this.mFragment.mContainer != null) {
            i = Math.max(i, 3);
        }
        if (FragmentManager.isLoggingEnabled(2)) {
    ...
    public Bundle saveState() {
        ...
        if (this.mFragment.mState > -1) {
            ...
            Bundle m360lambda$attachController$4$androidxfragmentappFragmentManager = this.mFragment.mChildFragmentManager.m360lambda$attachController$4$androidxfragmentappFragmentManager();
            if (!m360lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
                bundle.putBundle(CHILD_FRAGMENT_MANAGER_KEY, m360lambda$attachController$4$androidxfragmentappFragmentManager);
            }
            if (this.mFragment.mView != null) {
                saveViewState();
            }
