...
public final class RealConnectionPool {
    ...
    private final Runnable cleanupRunnable = new Runnable() { // from class: okhttp3.internal.connection.RealConnectionPool$$ExternalSyntheticLambda0
        ...
        public final void run() {
            RealConnectionPool.this.m2515lambda$new$0$okhttp3internalconnectionRealConnectionPool();
        }
    };
    ...
    public /* synthetic */ void m2515lambda$new$0$okhttp3internalconnectionRealConnectionPool() {
        while (true) {
