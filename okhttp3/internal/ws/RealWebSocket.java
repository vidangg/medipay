...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random, long j) {
        ...
        this.writerRunnable = new Runnable() { // from class: okhttp3.internal.ws.RealWebSocket$$ExternalSyntheticLambda0
            ...
            public final void run() {
                RealWebSocket.this.m2516lambda$new$0$okhttp3internalwsRealWebSocket();
            }
        };
    }
    ...
    public /* synthetic */ void m2516lambda$new$0$okhttp3internalwsRealWebSocket() {
        do {
            try {
            } catch (IOException e) {
        ...
        newWebSocketCall.enqueue(new Callback() { // from class: okhttp3.internal.ws.RealWebSocket.1
            ...
            public void onResponse(Call call, Response response) {
                ...
                try {
                    ...
                    try {
                        RealWebSocket.this.initReaderAndWriter("OkHttp WebSocket " + build2.url().redact(), exchange.newWebSocketStreams());
