...
interface zzor {
    ...
    void zzd(int i, zzld zzldVar) throws IOException;
    ...
    @Deprecated
    void zzq(int i, Object obj, zzns zznsVar) throws IOException;
    ...
    void zzv(int i, Object obj, zzns zznsVar) throws IOException;
