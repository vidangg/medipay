...
final class zzcw implements ObjectEncoderContext {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzcw zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzcw zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzcu zzj = zzj(fieldDescriptor);
