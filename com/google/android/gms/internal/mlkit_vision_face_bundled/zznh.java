...
public enum zznh implements zzbk {
    UNKNOWN_EVENT(0),
    ...
    AGGREGATED_CUSTOM_MODEL_INFERENCE(MlKitException.CODE_SCANNER_CANCELLED),
    AGGREGATED_ON_DEVICE_BARCODE_DETECTION(MlKitException.CODE_SCANNER_CAMERA_PERMISSION_NOT_GRANTED),
    AGGREGATED_ON_DEVICE_FACE_DETECTION(MlKitException.CODE_SCANNER_APP_NAME_UNAVAILABLE),
    ...
    OPTIONAL_MODULE_DOCUMENT_DETECT_RELEASE(RtspMessageChannel.DEFAULT_RTSP_PORT),
