...
interface zzmr {
    ...
    void zza(int i, zzht zzhtVar) throws IOException;

    <K, V> void zza(int i, zzkf<K, V> zzkfVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzlc zzlcVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzlc zzlcVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzlc zzlcVar) throws IOException;

    void zzb(int i, List<zzht> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzlc zzlcVar) throws IOException;
