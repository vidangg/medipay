...
public class MessagingAnalytics {
    ...
    public static boolean shouldUploadScionMetrics(Bundle bundle) {
        ...
        return IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(bundle.getString(Constants.AnalyticsKeys.ENABLED));
    }
    ...
    static int getPriority(Bundle bundle) {
        ...
        if (string == null) {
            if (IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(bundle.getString(Constants.MessagePayloadKeys.PRIORITY_REDUCED_V19))) {
                return 2;
            }
