...
public class WithinAppServiceBinder extends Binder {
    ...
    public void send(final WithinAppServiceConnection.BindRequest bindRequest) {
        ...
        this.intentHandler.handle(bindRequest.intent).addOnCompleteListener(new DashDownloader$$ExternalSyntheticLambda0(), new OnCompleteListener() { // from class: com.google.firebase.messaging.WithinAppServiceBinder$$ExternalSyntheticLambda0
