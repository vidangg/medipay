...
public final class StatsAccumulator {
    ...
    private double mean = AudioStats.AUDIO_AMPLITUDE_NONE;
    private double sumOfSquaresOfDeltas = AudioStats.AUDIO_AMPLITUDE_NONE;
    ...
    public final double populationVariance() {
        ...
        return this.count == 1 ? AudioStats.AUDIO_AMPLITUDE_NONE : DoubleUtils.ensureNonNegative(this.sumOfSquaresOfDeltas) / this.count;
    }
