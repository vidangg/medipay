...
public abstract class LinearTransformation {
    ...
    public static LinearTransformation horizontal(double y) {
        ...
        return new RegularLinearTransformation(AudioStats.AUDIO_AMPLITUDE_NONE, y);
    }
    ...
    public static final class RegularLinearTransformation extends LinearTransformation {
        ...
        public boolean isHorizontal() {
            return this.slope == AudioStats.AUDIO_AMPLITUDE_NONE;
        }
    ...
    public static final class VerticalLinearTransformation extends LinearTransformation {
        ...
        private LinearTransformation createInverse() {
            return new RegularLinearTransformation(AudioStats.AUDIO_AMPLITUDE_NONE, this.x, this);
        }
    }
