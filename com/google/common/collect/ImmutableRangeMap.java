...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    ...
    @CheckForNull
    public V get(K key) {
        int binarySearch = SortedLists.binarySearch(this.ranges, (com.google.common.base.Function<? super E, Cut>) Range.lowerBoundFn(), Cut.belowValue(key), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
