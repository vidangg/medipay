...
public interface InAppWebViewInterface {
    ...
    void postWebMessage(com.pichillilorenzo.flutter_inappwebview_android.types.WebMessage webMessage, Uri uri, ValueCallback<String> valueCallback);
    ...
    void setInFullscreen(boolean z);
