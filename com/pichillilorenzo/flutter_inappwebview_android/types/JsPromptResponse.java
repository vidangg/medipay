...
public class JsPromptResponse {
    ...
    public static JsPromptResponse fromMap(Map<String, Object> map) {
        ...
        return new JsPromptResponse((String) map.get(Constant.PARAM_ERROR_MESSAGE), (String) map.get("defaultValue"), (String) map.get("confirmButtonTitle"), (String) map.get("cancelButtonTitle"), ((Boolean) map.get("handledByClient")).booleanValue(), (String) map.get("value"), (Integer) map.get("action"));
    }
