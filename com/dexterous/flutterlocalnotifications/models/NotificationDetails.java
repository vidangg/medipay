...
public class NotificationDetails implements Serializable {
    ...
    private static void readPlatformSpecifics(Map<String, Object> map, NotificationDetails notificationDetails) {
        ...
        if (map2 != null) {
            ...
            notificationDetails.when = LongUtils.parseLong(map2.get(WHEN));
            ...
            notificationDetails.timeoutAfter = LongUtils.parseLong(map2.get(TIMEOUT_AFTER));
    ...
    private static void readStyleInformation(NotificationDetails notificationDetails, Map<String, Object> map) {
        ...
        if (notificationDetails.style == NotificationStyle.Inbox) {
    ...
    private static ArrayList<MessageDetails> readMessages(ArrayList<Map<String, Object>> arrayList) {
        ...
        if (arrayList != null) {
            ...
            while (it.hasNext()) {
                ...
                arrayList2.add(new MessageDetails((String) next.get("text"), LongUtils.parseLong(next.get(TIMESTAMP)), readPersonDetails((Map) next.get(PERSON)), (String) next.get(DATA_MIME_TYPE), (String) next.get(DATA_URI)));
            }
        }
        return arrayList2;
    }
