...
@DebugMetadata(c = "io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin$getDouble$1", f = "SharedPreferencesPlugin.kt", i = {}, l = {TsExtractor.TS_PACKET_SIZE}, m = "invokeSuspend", n = {}, s = {})
...
final class SharedPreferencesPlugin$getDouble$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SharedPreferencesPlugin$getDouble$1(String str, SharedPreferencesPlugin sharedPreferencesPlugin, Ref.ObjectRef<Double> objectRef, Continuation<? super SharedPreferencesPlugin$getDouble$1> continuation) {
        ...
        if (i == 0) {
            ...
            Flow<Double> flow = new Flow<Double>() { // from class: io.flutter.plugins.sharedpreferences.SharedPreferencesPlugin$getDouble$1$invokeSuspend$$inlined$map$1
                ...
                public static final class AnonymousClass2<T> implements FlowCollector {
                    ...
                    */
                    public final Object emit(Object obj, Continuation continuation) {
                        ...
                        int i;
                        SharedPreferencesListEncoder sharedPreferencesListEncoder;
                        if (continuation instanceof AnonymousClass1) {
                            ...
                            if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                                ...
                                if (i != 0) {
                                    ...
                                    sharedPreferencesListEncoder = this.this$0.listEncoder;
                                    Double d = (Double) SharedPreferencesPluginKt.transformPref(obj3, sharedPreferencesListEncoder);
                ...
                public Object collect(FlowCollector<? super Double> flowCollector, Continuation continuation) {
                    Object collect = Flow.this.collect(new AnonymousClass2(flowCollector, stringKey, sharedPreferencesPlugin), continuation);
