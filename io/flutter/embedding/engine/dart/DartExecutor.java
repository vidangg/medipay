...
public class DartExecutor implements BinaryMessenger {
    ...
    public DartExecutor(FlutterJNI flutterJNI, AssetManager assetManager, long j) {
    ...
    public void executeDartCallback(DartCallback dartCallback) {
        ...
        try {
            ...
            this.flutterJNI.runBundleAndSnapshotFromLibrary(dartCallback.pathToBundle, dartCallback.callbackHandle.callbackName, dartCallback.callbackHandle.callbackLibraryPath, dartCallback.androidAssetManager, null, this.engineId);
            this.isApplicationRunning = true;
            if (scoped != null) {
                scoped.close();
            }
