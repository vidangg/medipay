...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2474trySendImplMj0NB7M = conflatedBufferedChannel.m2474trySendImplMj0NB7M(e, true);
        if (m2474trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2460exceptionOrNullimpl(m2474trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m2474trySendImplMj0NB7M = conflatedBufferedChannel.m2474trySendImplMj0NB7M(e, true);
        if (!(m2474trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2446trySendJP2dKIU(E element) {
        return m2474trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2474trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2472trySendDropLatestMj0NB7M(element, isSendOp) : m2473trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2472trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2446trySendJP2dKIU = super.mo2446trySendJP2dKIU(element);
        if (ChannelResult.m2466isSuccessimpl(mo2446trySendJP2dKIU) || ChannelResult.m2464isClosedimpl(mo2446trySendJP2dKIU)) {
            return mo2446trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m2471successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m2473trySendDropOldestJP2dKIU(E element) {
    ...
    public void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo2446trySendJP2dKIU = mo2446trySendJP2dKIU(element);
        if (!(mo2446trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo2446trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2460exceptionOrNullimpl(mo2446trySendJP2dKIU);
