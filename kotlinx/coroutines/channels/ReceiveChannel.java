...
public interface ReceiveChannel<E> {
    ...
    Object mo2450receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2451tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo2451tryReceivePtdJZtk = receiveChannel.mo2451tryReceivePtdJZtk();
            if (ChannelResult.m2466isSuccessimpl(mo2451tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2462getOrThrowimpl(mo2451tryReceivePtdJZtk);
            }
            Throwable m2460exceptionOrNullimpl = ChannelResult.m2460exceptionOrNullimpl(mo2451tryReceivePtdJZtk);
            if (m2460exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m2460exceptionOrNullimpl);
        }
            ...
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo2450receiveCatchingJP2dKIU = receiveChannel.mo2450receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    ...
                    return ChannelResult.m2461getOrNullimpl(mo2450receiveCatchingJP2dKIU);
                }
            }
