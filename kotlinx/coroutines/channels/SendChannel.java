...
public interface SendChannel<E> {
    ...
    Object mo2446trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2446trySendJP2dKIU = sendChannel.mo2446trySendJP2dKIU(e);
            if (ChannelResult.m2466isSuccessimpl(mo2446trySendJP2dKIU)) {
                return true;
            }
            Throwable m2460exceptionOrNullimpl = ChannelResult.m2460exceptionOrNullimpl(mo2446trySendJP2dKIU);
