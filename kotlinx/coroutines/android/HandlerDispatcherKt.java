...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m944constructorimpl = Result.m944constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m944constructorimpl = Result.m944constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m950isFailureimpl(m944constructorimpl) ? null : m944constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2502dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
