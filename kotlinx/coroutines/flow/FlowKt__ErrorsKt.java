...
public final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    */
    public static final <T> Object catchImpl(Flow<? extends T> flow, FlowCollector<? super T> flowCollector, Continuation<? super Throwable> continuation) {
        ...
        if (continuation instanceof FlowKt__ErrorsKt$catchImpl$1) {
            ...
            if ((flowKt__ErrorsKt$catchImpl$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (!isSameExceptionAs$FlowKt__ErrorsKt(th, th) || isCancellationCause$FlowKt__ErrorsKt(th, flowKt__ErrorsKt$catchImpl$1.get$context())) {
                    throw th;
                }
                if (th == null) {
                    return th;
    ...
    /* renamed from: catch */
    public static final <T> Flow<T> m2486catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
