...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2503scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m2434delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2435toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2435toDelayMillisLRDsOJo(long j) {
        if (Duration.m2269compareToLRDsOJo(j, Duration.INSTANCE.m2373getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2288getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
